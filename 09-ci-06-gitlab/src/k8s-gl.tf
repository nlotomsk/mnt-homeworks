...
locals {
  folder_id             = "b1ggr42r00l9s0vb95gb"            # Set your cloud folder ID.
  k8s_version           = "regular"            # Set the Kubernetes version.
  zone_a_v4_cidr_blocks = "10.1.0.0/16" # Set the CIDR block for subnet.
  sa_name               = "admin"            # Set the service account name.
  registry_name         = "docker"            # Set the name of Yandex Container Registry.
}
